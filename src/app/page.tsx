      ...
      <section className="relative px-6 py-16 sm:py-20 lg:px-8">
        <Container>
          <div className="grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4">
            {[
              { value: '150+', key: 'projectsCompleted', icon: '📊' },
              { value: '25', key: 'countriesServed', icon: '🌍' },
              { value: '500+', key: 'teamMembers', icon: '👥' },
              { value: '30yrs', key: 'experience', icon: '⭐' },
            ].map((stat) => (
            ...
            {[
              ...
              <Card key={feature.key} className="p-8">
                ...
                <h3 className="text-xl font-semibold text-card-foreground">
                  {t(`whyChoose.${feature.key}.title`)}
                </h3>
                <p className="mt-3 text-base leading-7 text-muted-foreground">
                  {t(`whyChoose.${feature.key}.description`)}
                </p>
              </Card>
            ))}
          </div>
